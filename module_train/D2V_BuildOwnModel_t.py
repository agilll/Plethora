...
def buildD2VModelFrom_T_Folder(tfiles_folder, model_name, vector_size, window, alpha, min_alpha, min_count, distributed_memory, epochs):
	...
	buildD2VModelFrom_T_FileList(training_files, model_name, vector_size, window, alpha, min_alpha, min_count, distributed_memory, epochs)
	return 0


# A function to build a model based on Doc2Vec, trained by our own training .t documents
# receives a list of filenames .t documents
def buildD2VModelFrom_T_FileList(training_files, model_name, vector_size, window, alpha, min_alpha, min_count, distributed_memory, epochs):
	...
	for training_file in training_files:
		...
		training_lists.append(list_words) # each list is a file
